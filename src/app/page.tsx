...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Credentials setup
    const savedKey = localStorage.getItem('groq_api_key') || localStorage.getItem('claude_api_key') || localStorage.getItem('openrouter_api_key') || localStorage.getItem('gemini_api_key');
    if (savedKey) {
      setApiKey(savedKey);
